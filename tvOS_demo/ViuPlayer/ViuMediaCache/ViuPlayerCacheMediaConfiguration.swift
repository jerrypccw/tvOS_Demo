//
//  ViuPlayerCacheMediaConfiguration.swift
//  tvOS_demo
//
...
open class ViuPlayerCacheMediaConfiguration:NSObject, NSCoding, NSCopying {
    
    public fileprivate(set) var filePath: String?
    public fileprivate(set) var cacheSegments = [NSValue]()
    public var cacheMedia: ViuPlayerCacheMedia?
    public var url: URL?
    
    fileprivate let cacheSegmentQueue = DispatchQueue(label: "com.Viuplayer.CacheSegmentQueue")
    fileprivate let cacheDownloadInfoQueue = DispatchQueue(label: "com.Viuplayer.CacheDownloadInfoQueue")
    ...
    public required convenience init?(coder aDecoder: NSCoder) {
        guard let fileName = aDecoder.decodeObject(forKey: "fileName") as? String,
            ...
            let cacheMedia = aDecoder.decodeObject(forKey:"cacheMedia") as? ViuPlayerCacheMedia,
    ...
    public func copy(with zone: NSZone? = nil) -> Any {
        let confi = ViuPlayerCacheMediaConfiguration()
...
// MARK: - Update
extension ViuPlayerCacheMediaConfiguration {
    open func save() {
