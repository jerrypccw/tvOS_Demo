...
//open class JHPlayerSlider: UISlider {
//    
...
//        
//        let thumbImage = JHPlayerUtils.imageResource("ic_slider_thumb")
//        let normalThumbImage = JHPlayerUtils.imageSize(image: thumbImage!, scaledToSize: CGSize(width: 15, height: 15))
//        setThumbImage(normalThumbImage, for: .normal)
//        let highlightedThumbImage = JHPlayerUtils.imageSize(image: thumbImage!, scaledToSize: CGSize(width: 20, height: 20))
