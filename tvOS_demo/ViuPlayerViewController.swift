...
class ViuPlayerViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let playPauseTap = UITapGestureRecognizer(target: self, action: #selector(playPauseTap(tap: )))
        playPauseTap.allowedPressTypes = [NSNumber(value: UIPress.PressType.playPause.rawValue)]
        view.addGestureRecognizer(playPauseTap)
        
        let selectTap = UITapGestureRecognizer(target: self, action: #selector(selectTap(tap: )))
...
extension ViuPlayerViewController {
    ...
    @objc func playPauseTap(tap: UITapGestureRecognizer) {
    ...
    @objc func selectTap(tap: UITapGestureRecognizer) {
